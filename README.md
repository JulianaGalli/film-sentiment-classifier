# Projeto Film Sentiment Classifier: Explorando do TF-IDF ao BERT
...
O spaCy exige que o modelo de linguagem seja baixado separadamente após a instalação da biblioteca:
python -m spacy download en_core_web_sm

## Projeto Desenvolvido por Juliana Galli
